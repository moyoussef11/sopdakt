    ...
    <Link to={`/blog/blog-details/${id}`}>
      ...
      >
        <div className="top relative rounded-[11px]">
          <img
            src={blogImg}
            className="h-[200px] sm:h-[250px] md:h-[300px] w-full  rounded-[11px]"
            alt={title}
          />
        ...
        <div className="info px-4 flex flex-col items-center justify-center md:items-start md:justify-start py-3">
          <h4 className="text-[21px] leading-[26px] tracking-normal uppercase font-medium">
            {title}
          </h4>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col gap-2">
              <h3 className="uppercase text-[14px] font-semibold">{author}</h3>
              <div className="flex items-center gap-2 text-[14px] text-[#2B2C34]">
                {" "}
